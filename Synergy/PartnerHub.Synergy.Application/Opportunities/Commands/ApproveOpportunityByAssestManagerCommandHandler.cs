...
{
    public class ApproveOpportunityByAssestManagerCommandHandler : IRequestHandler<ApproveOpportunityByAssestManagerCommand, Result>
    {
        private readonly IOpportunityRepository _opportunityRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserService _userService;
        public ApproveOpportunityByAssestManagerCommandHandler(IOpportunityRepository opportunityRepository, 
        ...
        public async Task<Result> Handle(ApproveOpportunityByAssestManagerCommand request, CancellationToken cancellationToken)
        {
